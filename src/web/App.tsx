...
export function App() {
  ...
  async function runAutoB() {
    setAuto(true);
    caseStore.reset();
    await caseStore.start();
    await sleep(800);
    await caseStore.finalApproval();
    setAuto(false);
  }

  const handleSelectCase = (id: "A" | "B") => {
    ...
    <div className="app">
      ...
      <div className="bottombar">
        ...
        <div className="case-tabs">
          ...
          <button
            className={`btn ${caseId === "A" ? "primary" : "ghost"}`}
          ...
          <button
            className={`btn ${caseId === "B" ? "primary" : "ghost"}`}
        ...
        <div className="controls">
          ...
          <button
            className="btn"
            disabled={auto}
            onClick={caseId === "A" ? runAutoA : runAutoB}
          >
            ▶ Auto demo
          </button>
